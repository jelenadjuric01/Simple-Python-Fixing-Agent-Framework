...
#
# `__file__` is this file; .parents[1] climbs agentfix/ -> tree root. In the Academy course
# that root is the framework lesson's task directory, which is also the sources root.
