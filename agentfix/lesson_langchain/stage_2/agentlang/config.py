...
# src/agentlang/ -> src/ -> repo root, derived rather than hardcoded so the path is right
...
# `agentlang doctor` fails if the loaded model reports less than this. A too-small context
