...
from agentlang.agent.graph import NUDGE, run_agent
...
from agentlang.tools.fs import ListFilesTool, ReadFileTool, WriteFileTool
...
class TempDirTestCase(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.tmp = Path(tempfile.mkdtemp(prefix="agentfix_test_")).resolve()
...
class TestToolCallsAlwaysRun(Stage1TestCase):
    ...
    def test_a_call_whose_json_did_not_parse_still_counts_as_asking(self):
        ...
        from agentlang.llm.fake import assistant_invalid_tool_call
