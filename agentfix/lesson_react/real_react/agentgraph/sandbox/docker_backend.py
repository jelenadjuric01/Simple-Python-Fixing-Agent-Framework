...
Enabled with AGENTGRAPH_SANDBOX=docker, after building the image:
...
from agentgraph.sandbox.subprocess_backend import TRUNCATION_MARKER

DEFAULT_IMAGE = "agentgraph-sandbox:latest"
...
class DockerBackend:
    ...
    def build_argv(
        ...
        return [
            ...
            # The mount is read-only, so bytecode must not be written next to the sources.
            "--env",
    ...
    def _container_name() -> str:
        ...
        return f"agentgraph-{uuid.uuid4().hex[:12]}"
